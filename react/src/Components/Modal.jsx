  ...
  return (
    <>
      ...
      <div className="modal-box" id="modalBox">
        <div
          className={
            props.pokemon.seletor
              ? "modal-card " + modalColorDictionary(props.pokemon.seletor)
              : "modal-card modal-card-orange"
          }
        >
          ...
          <div className="modal-details">
            ...
            <br />
            Special Attack:{props.pokemon.special_attack}
            <br />
            Special Defense:{props.pokemon.special_defense}
            <br />
          </div>
        </div>
      </div>
